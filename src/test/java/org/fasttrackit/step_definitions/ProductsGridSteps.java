...
public class ProductsGridSteps extends TestBase {
    ...
    public void theProductsAreOrderedByPriceInDescendingOrder(String sortDirection) {
        ...
        assertThat("No products prices could be extracted", prices, hasSize(greaterThan(0)));
    ...
    public void iAddOneProductToCart() {productsGrid.getAddToCartButton().click();
    }


    @And("^I select another product$")
    public void iSelectAnotherProduct() {productsGrid.getCandleHolder().click();
    }
}
